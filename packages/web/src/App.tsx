...
export default function App() {
  ...
  return <div className="app">
    ...
    {screen === "report" && <main className="screen report"><h2>FAILURES: 01</h2><div className="failure-table" role="table"><div className="row heading"><span>FAILURE_NAME</span><span>SEVERITY</span></div><button className="row" onClick={() => void openDetail()}><span>[FAILED_SCHEDULE_01]</span><span>CRITICAL</span></button><div className="row"><span>[MINIMIZED_REPRO]</span><span>READY</span></div><div className="row"><span>[PINPOINT_ERROR]</span><span>CAPTURED</span></div></div><a className="export" href={`/api/runs/${run?.id}/report`} download><Download size={14}/> EXPORT_REPORT</a></main>}
