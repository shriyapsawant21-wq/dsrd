...
| 7. CLI/API workflows | In progress | CLI exposes baseline/confirmation counts, explicit terminal outcomes, and stable process exit codes; API preserves explicit orchestration outcomes, and CLI/API use the shared replay gate. Stable JSON output and end-to-end onboarding commands remain |
