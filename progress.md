...
| 7. CLI/API workflows | In progress | CLI exposes baseline/confirmation counts, explicit terminal outcomes, stable process exit codes, and delegates search to the shared discovery service; API preserves explicit orchestration outcomes and delegates to that same service. Stable JSON output and end-to-end onboarding commands remain |
